...
function MaintainVendor() {
  ...
  return (
    <div
      className="relative flex size-full min-h-screen flex-col bg-slate-50 justify-between group/design-root overflow-x-hidden w-full max-w-screen-2xl mx-auto"
      style={{
    ...
    >
      <div>
        ...
        <div className="w-full flex justify-center mt-4">
          <button className="flex min-w-[84px] cursor-pointer items-center justify-center rounded-xl h-10 px-6 bg-[#0e141b] text-white text-sm font-medium leading-normal">
            Confirm
          </button>
        </div>
        <h2 className="text-[#0e141b] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">
